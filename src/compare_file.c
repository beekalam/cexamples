...
#include <stdlib.h>
/*
 * Write a program that reads the names of two files, compares them line by line
(assume that each line contains less than 100 characters), and displays their first
common line. If the two files have no common line, the program should display an
informative message.
 */
int main()
{
