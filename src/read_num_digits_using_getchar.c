...
{
    /* 
     * Write a program that reads a number’s digits and displays its value. If the user enters
a sign, it should be taken into account. If the user inserts a nondigit character, the
